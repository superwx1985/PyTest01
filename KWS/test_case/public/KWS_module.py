...
def checkout_via_credit_card(driver, ccinfo=1):
    ...
    wait_element.try_to_enter(driver.br, 'id', 'CCCCV', 5, data[ccinfo][3])
    wait_element.try_to_click(driver.br, 'xpath', '//select[@id="CCExpMon"]/option[text()="'+data[ccinfo][4]+'"]', 5)
    wait_element.try_to_click(driver.br, 'xpath', '//select[@id="CCExpYear"]/option[text()="'+data[ccinfo][5]+'"]', 5)
    submit_button = wait_element.wait_for_element_visible(driver.br, 'xpath', '//a[contains(text(),"SUBMIT ORDER")]', 5)
